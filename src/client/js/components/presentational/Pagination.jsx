...
class Pagination extends Component {
  ...
  render() {
    const pageNumbers = [];
    const { currentPage, maxCount } = this.props;
    ...
    const paginationItems = pageNumbers.map(number => (
      <PaginationItem key={number} number={number} currentPage={currentPage} pageClick={this.props.pageClick} />
    ));
    return (
      <ul className="pagination">
        ...
        {moreNextExist ? (
          <PaginationItem key={maxCount} number={maxCount} currentPage={currentPage} pageClick={this.props.pageClick} />
        ) : null}
        <li className="page-item">
