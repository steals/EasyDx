      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
          ...
          <div className="row from-group input-bar">
            ...
            <input type="text" className="form-control" value={this.state.userName} onChange={this.handleUserChange} />
          </div>
          <div className="row from-group input-bar">
          ...
          <button type="button" className="btn btn-primary form-button" onClick={this.handleAssignPermission}>
            Assign Permission
          </button>
        </div>
      </div>
