        ...
        <div className="card-body">
          <div className="row from-group">
            <div className="checkbox form-check">
              <input
                type="checkbox"
                defaultChecked={this.state.forcePull}
          ...
          <div className="row from-group">
            <div className="checkbox form-check">
              <input
                type="checkbox"
                defaultChecked={this.state.OtherOrg}
          ...
          <button type="button" className="btn btn-primary form-button" onClick={this.handlePullSource}>
            Pull Changes
          </button>
        </div>
      </div>
