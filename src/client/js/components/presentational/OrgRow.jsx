...
class OrgRow extends Component {
  ...
  handleDeleteOrg() {
    const confirmDelete = confirm('Are you sure you want to delete this org?');
        ...
        <td>
          <div className="btn-group">
            ...
            <div className="dropdown-menu">
              <a className="dropdown-item" href="javascript:;" onClick={this.handleShowDetail}>
                Display Org Details
              </a>
              <a className="dropdown-item" href="javascript:;" onClick={this.handleOpenOrg}>
                Open Org
              </a>
              <a className="dropdown-item" href="javascript:;" onClick={this.handleDefaultOrg}>
                Set as Default Org
              </a>
              {showDefaultDevhub ? (
                <a className="dropdown-item" href="javascript:;" onClick={this.handleDefaultDevhub}>
                  Set as Default Devhub
                </a>
              ) : null}
              <a className="dropdown-item" href="javascript:;" onClick={this.handleDeleteOrg}>
                Delete Org
              </a>
            </div>
          </div>
