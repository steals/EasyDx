  ...
  render() {
    ...
    if (this.state.searchValue !== '') {
      ...
      for (let i = 0; i < this.props.convertResults.length; i++) {
        const fullName = this.props.convertResults[i].fullName.toLowerCase();
    ...
    const convertResultRows = currentRecords.map(convertResult => (
      <ProjectConvertResultRow key={this.props.title + convertResult.filePath} convertResult={convertResult} />
    ));
    return (
